...
namespace Tap_Taste
{
    public partial class Form3 : Form
    {
        ...
        public void LoadProducts()
        {
            ...
            using (SqlConnection con = new SqlConnection(conString))
            {
                try
                {
                    ...
                    // AJOUT des champs idcategorie et imagepath pour que btnmodifier_Click puisse les récupérer
        ...
        private void btnmodifier_Click(object sender, EventArgs e)
        {
            ...
            // 2. Récupération des données sélectionnées
            ...
            // 3. Ouvrir Form4 en mode édition
            // CORRECTION : Appel du constructeur avec les 6 arguments
        ...
        {
            // Peut rester vide si non utilisé
        }
        ...
        private void btnsupp_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(conString))
            {
                try
                {
                    ...
                    // Requête de suppression utilisant un paramètre pour éviter l'injection SQL
                    ...
                    // 3. Exécuter la commande de suppression
                    ...
                    if (rowsAffected > 0)
                    {
                        ...
                        // 4. Mettre à jour le DataGridView après la suppression
                        LoadProducts();
                    }
                    else
                    {
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            {
                // Recherche texte → nom ou categorie (idcategorie est de type int, la recherche sur nom est plus logique)
            ...
            // ATTENTION : La chaîne de connexion ici est différente de celle dans LoadProducts !
            // J'ai mis la même que LoadProducts pour la cohérence
